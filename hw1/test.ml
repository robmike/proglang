...
is_older((1,2,3), (1,4,3)) = true
is_older((1,2,3), (4,2,3)) = true
...
dates_in_month([(1,2,3), (4,2,5), (1,1,1), (4,2,3)], 2) = [(4,2,3),(4,2,5),(1,2,3)];
dates_in_month([(1,2,3), (4,2,5), (1,1,1), (4,2,3)], 1) = [(1,1,1)];
dates_in_month([(1,2,3), (4,2,5), (1,1,1), (4,2,3)], 8) = [];

dates_in_months([(1,2,3), (4,2,5), (1,1,1), (4,2,3)], [2,1,8]) = [(1,1,1), (4,2,3),(4,2,5),(1,2,3)]
dates_in_months([(1,2,3), (4,2,5), (1,1,1), (4,2,3)], [9,8]) = []
...
oldest([(1,1,2), (1,1,3), (1, 3,4), (2,3,5), (1,1,1)]) = SOME (1,1,1)
